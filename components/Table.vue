...
export default {
  ...
  async created() {
    ...
    // const sortFn = (a, b) => {
    //   const disA = a.healthCareDistrict.toLowerCase()
    //   const disB = b.healthCareDistrict.toLowerCase()
    //   if (disA < disB) {
    //     return 1
    //   } else if (disA > disB) {
    //     return -1
